...
# Run on the Raspberry Pi as the deploy user
set -euo pipefail
...
echo "     sudo systemctl enable --now chronos-auto-update.timer"
echo ""
echo "  3. Check status:    sudo systemctl status 'chronos-*'"
echo "  4. View logs:       journalctl -u chronos-ui -f"
echo "  5. Verify health:   ~/PlaudBlender/deploy/verify-pi.sh"
echo "  6. Update later:    ~/PlaudBlender/deploy/update-pi.sh"
echo ""
