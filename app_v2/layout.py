        ...
        children=[
            ...
            html.Main(
                ...
                children=[
                    ...
                    html.Div(
                        className="app-runtime-strip",
                        children=[
                            html.Div(
                                id="app-runtime-status",
                                className="app-runtime-status",
                            ),
                            html.Div(
                                className="app-runtime-actions",
                                children=[
                                    html.A(
                                        "Open Chronos",
                                        id="app-runtime-access-link",
                                        className="app-runtime-link",
                                        href="#",
                                        target="_blank",
                                        rel="noreferrer",
                                        style={"display": "none"},
                                    ...
                                    html.Button(
                                        "Notion",
                                        id="shell-open-notion",
                                        className="app-runtime-action secondary",
                                        n_clicks=0,
                                    ),
                                    html.Button(
                                        "Sync",
                                        id="shell-open-sync",
                                        className="app-runtime-action",
                                        n_clicks=0,
                                    ),
                                    html.Button(
                                        "System",
                                        id="shell-open-system",
                                        className="app-runtime-action secondary",
                                        n_clicks=0,
                                    ),
                                ],
                    ...
                    html.Div(
                        id="app-workspace-pulse",
                        className="app-workspace-pulse",
                    ),
