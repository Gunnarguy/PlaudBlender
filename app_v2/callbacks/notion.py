...
def register_notion_callbacks(app):
    ...
    def poll_import_progress(n_intervals):
        ...
        if status == "running":
            ...
            pause_reason = progress.get(
                "pause_reason",
                "Import paused before this batch completed.",
            )
            ...
            return html.Div(children=children), True
